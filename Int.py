...
@if (isTextInput(getRuntimeState(field).type) || getRuntimeState(field).type === 'date' || getRuntimeState(field).type === 'time') {
  <mat-form-field appearance="outline" class="df__full-width">
    ...
    <input matInput
           ...
           [type]="inputType(getRuntimeState(field).type)"
...
@if (getRuntimeState(field).type === 'textarea') {
  <mat-form-field appearance="outline" class="df__full-width">
    <mat-label>{{ getRuntimeState(field).label || field.label }}</mat-label>
    <textarea matInput
              [id]="fieldId(field, parentPath)"
  ...
  <mat-form-field appearance="outline" class="df__full-width">
    ...
    <mat-select [id]="fieldId(field, parentPath)"
      ...
      @if (getRuntimeState(field).placeholder) {
        <mat-option [value]="null" disabled>{{ getRuntimeState(field).placeholder }}</mat-option>
      }
...
@if (getRuntimeState(field).type === 'autocomplete') {
  <mat-form-field appearance="outline" class="df__full-width">
    <mat-label>{{ getRuntimeState(field).label || field.label }}</mat-label>
    <input type="text"
           matInput
